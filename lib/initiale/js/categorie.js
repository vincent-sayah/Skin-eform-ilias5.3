...
var menu = '<div class="col-lg-offset-1 col-md-offset-1 col-xs-offset-0 col-lg-10 col-md-10 col-xs-12 id="menu_filtre_eform" id="colonnage1"><ul id="nav_filtres">';

for (i=0; i<categories.categories.length; i++){
    menu += '<li id='+categories.categories[i].name+' onclick="afficherParCategorie('+i+', this)"><a href="#">'+categories.categories[i].name+'</a></li>';
}
menu += '</ul></div>';
